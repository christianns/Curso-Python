...
# Como ya sabemos los números se pasan por valor y crean una copia dentro de
# la función, por eso no les afecta externamente lo que hagamos con ellos:
...
# Sin embargo las listas u otras colecciones, al ser tipos compuestos se pasan por referencia,
# y si las modificamos dentro de la función estaremos modificándolas también fuera:
