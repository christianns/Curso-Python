...
# Cada error tiene un identificador único que curiosamente se corresponde con
# su tipo de dato. Aprovechándonos de eso podemos mostrar la clase del error utilizando
# la sintaxis:
...
# Como vemos siempre nos indica eso de "class" delante.
...
# consultando su propiedas especial name de la siguiente forma:
...
# siempre que dejemos en último lugar la excepción por defecto Excepcion que
# engloba cualquier tipo de error (si la pusiéramos al principio las demas
# excepciones nunca se ejecutarían):
